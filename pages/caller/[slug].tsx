  ...
  return (
    <main className="flex flex-col ml-2 mr-2 xl:ml-40 xl:mr-40 md:ml-20 md:mr-20 mt-24 py-2 bg-slate-900 text-white space-y-4">
      ...
      <div className="flex flex-row transition-all relative">
        <div className='flex flex-row mt-8 mb-8 w-full justify-between items-end'>
          <div className='flex items-end'>
            <img className='rounded-full border-4 border-slate-800 align-middle h-28 w-28 md:h-32 md:w-32 object-cover' src="/images/sponge.png"/>
