...
function FeaturedCallerItem({name, image, wallet, OnClick}: Props) {
  ...
  return (
    <div className="overflow-hidden w-60 h-60 cursor-pointer rounded-lg relative group flex-none snap-always snap-center" onClick={handleClick}>
      <div className="rounded-lg z-10 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-black/90 to-transparent bg-gradient-to-t inset-x-0 -bottom-4 pt-30 text-white flex items-end">
        <div>
